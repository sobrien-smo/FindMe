...
const DummyProfile = ({ person, onSelectedPerson }) => {
        ...
        <div>
            ...
            <div className="profileContainer">
                <div className="otherRow">
                    <h2>{DummyFollowers[0].name}</h2>
                    <img src={img1} className='topPfp' />
                    <div className="cBox">
                        <div>{DummyFollowers[0].currentPosition} </div>
                ...
                <div className="followCounts">
                    ...
                    <div>
                        <h4>Followers</h4>
                        <div className='fnum'>{DummyFollowers[0].followers}</div>
                    </div>

                    <div>
                        <h4>Following</h4>
                        <div className='fnum'>{DummyFollowers[0].following}</div>
                    </div>
                ...
                <div className='ed'>
                    ...
                    <div>
                        <ul>
                            ...
                            <li>{DummyFollowers[0].education}</li>
                        </ul>
                    </div>
                </div>
                <div className='exp'>
                    ...
                    <div>
                        <ul>
                            <li>{DummyFollowers[0].experience}</li>
            ...
            <div className='profilePosts'>
                {
                    DummyFollowers[0].posts.map((post, id) => {
                                    ...
                                    <div key={id} className="grid-item">
                                        ...
                                        <div className="row1">
                                            ...
                                            <div className="pfpContainer">
                                                <div className='' ><img src={img1} className='pfp' /></div>
                                            </div>

                                            <div className="group">
                                                <div className='postName'>{DummyFollowers[0].name}</div>
