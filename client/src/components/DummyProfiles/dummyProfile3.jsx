...
const DummyProfile3 = ({ person, onSelectedPerson }) => {
        ...
        <div>
            ...
            <div className="profileContainer">
                <div className="otherRow">
                    <h2>{DummyFollowers[2].name}</h2>
                    <img src={img2} className='topPfp' />
                    <div className="cBox">
                        <div>{DummyFollowers[2].currentPosition} </div>
                ...
                <div className="followCounts">
                    ...
                    <div>
                        <h4>Followers</h4>
                        <div className='fnum'>{DummyFollowers[2].followers}</div>
                    </div>

                    <div>
                        <h4>Following</h4>
                        <div className='fnum'>{DummyFollowers[2].following}</div>
                    </div>
                ...
                <div className='ed'>
                    ...
                    <div>
                        <ul>
                            ...
                            <li>{DummyFollowers[2].education}</li>
                        </ul>
                    </div>
                </div>
                <div className='exp'>
                    ...
                    <div>
                        <ul>
                            <li>{DummyFollowers[2].experience}</li>
            ...
            <div className='profilePosts'>
                {
                    DummyFollowers[2].posts.map((post, id) => {
                                            ...
                                            <div key={id} className="grid-item">
                                                ...
                                                <div className="row1">
                                                    ...
                                                    <div className="pfpContainer">
                                                        <div className='' ><img src={img2} className='pfp' /></div>
                                                    </div>

                                                    <div className="group">
                                                        <div className='postName'>{DummyFollowers[2].name}</div>
