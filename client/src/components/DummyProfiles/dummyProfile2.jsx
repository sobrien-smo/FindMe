...
const DummyProfile2 = ({ person, onSelectedPerson }) => {
        ...
        <div>
            ...
            <div className="profileContainer">
                <div className="otherRow">
                    <h2>{DummyFollowers[1].name}</h2>
                    <img src={image7} className='topPfp' />
                    <div className="cBox">
                        <div>{DummyFollowers[1].currentPosition} </div>
                ...
                <div className="followCounts">
                    ...
                    <div>
                        <h4>Followers</h4>
                        <div className='fnum'>{DummyFollowers[1].followers}</div>
                    </div>

                    <div>
                        <h4>Following</h4>
                        <div className='fnum'>{DummyFollowers[1].following}</div>
                    </div>
                ...
                <div className='ed'>
                    ...
                    <div>
                        <ul>
                            ...
                            <li>{DummyFollowers[1].education}</li>
                        </ul>
                    </div>
                </div>
                <div className='exp'>
                    ...
                    <div>
                        <ul>
                            <li>{DummyFollowers[1].experience}</li>
            ...
            <div className='profilePosts'>
                {
                    DummyFollowers[1].posts.map((post, id) => {
